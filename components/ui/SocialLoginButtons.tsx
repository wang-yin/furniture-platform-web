export default function SocialLoginButtons() {
  return (
    <div className="flex justify-around space-x-6 mb-7 sm:mb-5">
      <button className="p-2 rounded-full hover:bg-blue-100 transition cursor-pointer shadow-md sm:shadow-lg hover:-translate-y-0.5">
        <svg
      ...
      <button className="p-2 rounded-full hover:bg-gray-100 transition cursor-pointer shadow-md sm:shadow-lg hover:-translate-y-0.5">
        <svg
      ...
      <button className="p-2 rounded-full hover:bg-red-100 transition cursor-pointer shadow-md sm:shadow-lg hover:-translate-y-0.5">
